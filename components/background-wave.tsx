...
export function AudioVisualizer({ isActive, isSpeaking, inputVolume = 0, outputVolume = 0 }: AudioVisualizerProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      {/* YouTube video embed as background with better loading */}
      <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-purple-900 via-indigo-900 to-violet-900">
