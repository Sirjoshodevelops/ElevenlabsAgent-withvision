...
export const BackgroundWave = () => {
  return (
    <div className="fixed inset-0 z-[1] pointer-events-none overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-black">
      <motion.video
        src="/wave-loop.mp4"
        autoPlay
        muted
      ...
      className="fixed object-cover bottom-0 z-[1] hidden md:block pointer-events-none opacity-60 dark:opacity-40"
        className="fixed object-cover bottom-0 z-[1] hidden md:block pointer-events-none opacity-90 dark:opacity-80"
        style={{
